...
class AddHabitViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) { getDataFromDB() }
    
    @IBAction func pressCompleteButton(_ sender: Any) { // 완료 버튼 누르면 실행
        getDataFromDB()
        if (iconImageName == "") { iconImageName = "star" } // default icon은 star
        if (titleTextField.text?.isEmpty != true && explainTextField.text?.isEmpty != true) { // 모든 텍스트 필드가 공백이 아닌 경우
            if (countOfHabits > 6) {
                if (countOfHabits % 6 == 0) {
                    countOfHabits = 6
                } else { countOfHabits = countOfHabits % 6 }
            }
            self.ref.child("users/Habit/Habit" + "\(self.countOfHabits)" + "/countOfHabits").setValue(["count": countOfHabits])
    ...
    @IBAction func clickAlarmBtn(_ sender: Any) { buttonClick(0, alarmIconBtn) }
    @IBAction func clickBedBtn(_ sender: Any) { buttonClick(1, bedIconBtn) }
    @IBAction func clickBookBtn(_ sender: Any) { buttonClick(2, bookIconBtn) }
    @IBAction func clickComputerBtn(_ sender: Any) { buttonClick(3, computerIconBtn) }
    @IBAction func clickCookingBtn(_ sender: Any) { buttonClick(4, cookingIconBtn) }
    @IBAction func clickDietBtn(_ sender: Any) { buttonClick(5, dietIconBtn) }
    @IBAction func clickFacialCareBtn(_ sender: Any) { buttonClick(6, facialCareIconBtn) }
    @IBAction func clickKeyboardBtn(_ sender: Any) { buttonClick(7, keyboardIconBtn) }
    @IBAction func clickMedicineBtn(_ sender: Any) { buttonClick(8, medicineIconBtn) }
    @IBAction func clickMoneyBtn(_ sender: Any) { buttonClick(9, moneyIconBtn) }
    @IBAction func clickPencilBtn(_ sender: Any) { buttonClick(10, pencilIconBtn) }
    @IBAction func clickRunningBtn(_ sender: Any) { buttonClick(11, runningIconBtn) }
    @IBAction func clickSpeakingBtn(_ sender: Any) { buttonClick(12, speakingIconBtn) }
    @IBAction func clickStarBtn(_ sender: Any) { buttonClick(13, starIconBtn) }
    @IBAction func clickWaterBtn(_ sender: Any) { buttonClick(14, waterIconBtn) }
    ...
    @IBAction func selectRed(_ sender: Any) { selectColor(0) }
    @IBAction func selectGreen(_ sender: Any) { selectColor(1) }
    @IBAction func selectIndigo(_ sender: Any) { selectColor(2) }
    @IBAction func selectPurple(_ sender: Any) { selectColor(3) }
    @IBAction func selectYellow(_ sender: Any) { selectColor(4) }
    @IBAction func selectOrange(_ sender: Any) { selectColor(5) }
